"""
URL configuration for mobilecrm project.
...
urlpatterns = [
    ...
    path('mobile/create/',views.MobileCreateView.as_view(),name="mobile-add"),
    path('mobile/list/',views.MobileListView.as_view(),name="mobile-list"),
